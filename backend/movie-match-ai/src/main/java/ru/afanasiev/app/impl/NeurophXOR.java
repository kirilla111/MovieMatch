...
public class NeurophXOR {
    ...
    public static NeuralNetwork trainNeuralNetwork(NeuralNetwork ann) {
        ...
        DataSetRow rOne = new DataSetRow(new double[]{0, 1, 1}, new double[]{1});
        ds.addRow(rOne);
        DataSetRow rTwo = new DataSetRow(new double[]{1, 1, 1}, new double[]{1});
        ds.addRow(rTwo);
        DataSetRow rThree = new DataSetRow(new double[]{0, 0, 1}, new double[]{1});
        ds.addRow(rThree);
        DataSetRow rFour = new DataSetRow(new double[]{1, 0, 1}, new double[]{1});
        ds.addRow(rFour);
